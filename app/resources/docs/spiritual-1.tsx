  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.header}>Understanding the Rituals of Umrah</Text>
        <Text style={styles.subHeader}>A step-by-step guide to performing Umrah.</Text>
        ...
        <View style={styles.sectionContainer}>
          <Text style={styles.sectionHeader}>1. Ihram (State of Purity)</Text>
          <Text style={styles.description}>
        ...
        <View style={styles.sectionContainer}>
          <Text style={styles.sectionHeader}>2. Tawaf (Circumambulation)</Text>
          <Text style={styles.description}>
        ...
        <View style={styles.sectionContainer}>
          <Text style={styles.sectionHeader}>3. Sa’i (Walking between Safa and Marwah)</Text>
          <Text style={styles.description}>
        ...
        <View style={styles.sectionContainer}>
          <Text style={styles.sectionHeader}>4. Tahallul (Shaving or Trimming Hair)</Text>
          <Text style={styles.description}>
